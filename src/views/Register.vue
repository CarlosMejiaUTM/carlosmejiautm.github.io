        ...
        <div v-else class="form-wrapper">
          ...
          <form @submit.prevent="register" class="form">
            <div class="input-group">
              ...
              <input id="username" v-model="form.username" type="text" placeholder="Elige un nombre de usuario" required autocomplete="username" />
            </div>

            <div class="input-group">
              <label for="email">Correo electrónico</label>
              <i class="input-icon icon-mail"></i>
              <input id="email" v-model="form.email" type="email" placeholder="tu@correo.com" required autocomplete="email" />
            </div>

            <div class="input-group">
              <label for="password">Contraseña</label>
              <i class="input-icon icon-lock"></i>
              <input id="password" v-model="form.password" :type="passwordFieldType" placeholder="Crea una contraseña segura" required autocomplete="new-password" />
            ...
            <div class="input-group">
              ...
              <i class="input-icon icon-lock"></i>
              <input id="password-confirm" v-model="form.passwordConfirm" :type="confirmPasswordFieldType" placeholder="Repite la contraseña" required autocomplete="new-password" @blur="validatePasswordsMatch" />
...
const register = async () => {
  ...
  try {
    ...
    error.value = err.response?.data?.message || 'Error al registrar. Inténtalo de nuevo.';
  } finally {
    loading.value = false;
  }
};
